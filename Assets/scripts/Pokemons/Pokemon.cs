...
public class Pokemon
{
    ...
    public void ApplyBoosts(List<StatBoost> statBoosts)
    {
        foreach (var statBoost in statBoosts)
        {
            ...
            if (boost > 0)
                StatusChanges.Enqueue($"{Base.PName}'s {stat} rose!");
            else
                StatusChanges.Enqueue($"{Base.PName}'s {stat} fell!");
    ...
    public void SetStatus(ConditionID conditionId)
    {
        ...
        StatusChanges.Enqueue($"{Base.PName} {Status.StartMessage}");
    ...
    public void SetVolatileStatus(ConditionID conditionId)
    {
        ...
        StatusChanges.Enqueue($"{Base.PName} {VolatileStatus.StartMessage}");
    }
    ...
    {
        Status?.OnAfterTrun?.Invoke(this);
        VolatileStatus?.OnAfterTrun?.Invoke(this);
    }
